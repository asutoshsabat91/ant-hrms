      ...
      <form onSubmit={loginForm.handleSubmit(onLogin)} className="space-y-4">
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-zinc-950 px-2 text-zinc-500 font-extrabold tracking-wider text-[8px]">Or</span>
          </div>
        </div>
        ...
        <Button
          ...
          className="w-full bg-white hover:bg-zinc-100 text-zinc-950 font-bold h-11 rounded-xl transition-all flex items-center justify-center gap-2"
        >

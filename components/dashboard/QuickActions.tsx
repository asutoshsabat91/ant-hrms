  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {actions.map((action) => (
        ...
        >
          {/* Bottom-to-top sweep background */}
          ...
          <div className="relative z-10 flex flex-col justify-between h-full w-full">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-zinc-900 group-hover:text-white transition-colors duration-500 ease-[var(--ease-out-expo)]">
                {action.label}
              </span>
              <ArrowUpRight className="h-4 w-4 text-zinc-400 group-hover:text-white group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-500 ease-[var(--ease-out-expo)]" />
            </div>
            <span className="mt-2 text-[10px] font-medium text-zinc-400 group-hover:text-zinc-300 transition-colors duration-500 ease-[var(--ease-out-expo)]">
              {action.desc}
            </span>
          </div>
        </Link>

...
export function JoiningSoonWidget({ hires }: { hires: OnboardingHire[] }) {
  ...
  useEffect(() => {
    // Add a slight delay to trigger the transition after the widget mounts/reveals
  ...
  const displayHires = hires.length > 0 ? hires.map((h, i) => ({
    ...h,
  ...
  })) : [
    {
      ...
      firstName: "Tanvi",
      lastName: "Bose",
      designation: "Frontend Engineer · Offer Accepted",
      joiningDate: new Date("2026-06-16"),
      progress: 35,
    },
    {
      id: "2",
      firstName: "Vikram",
      lastName: "Joshi",
      designation: "Sprint Coordinator · Documents",
      joiningDate: new Date("2026-06-22"),
      progress: 90,
    },
    {
      id: "3",
      firstName: "Ritika",
      lastName: "Pillai",
      designation: "Account Executive · Equipment",
      joiningDate: new Date("2026-06-09"),
      progress: 75,
    },
    {
      id: "4",
      firstName: "Sahil",
      lastName: "Malhotra",
      designation: "Talent Researcher · Orientation",
      joiningDate: new Date("2026-06-05"),
      progress: 100,
    }
  ];
